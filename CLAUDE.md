...
| 2026-05-19 | SEO/AEO production cleanup | Added a real /about page, restored /about from redirect to indexable page, added /about to sitemap and llms.txt, repaired blog hub BlogPosting schema with images/publisher/dateModified, added missing post schema, added missing LocalBusiness addresses on priority city pages, fixed minor audit warnings on tools, premium-markets, and blog author images, and documented Logan's SEO/AEO intake requirements. |
